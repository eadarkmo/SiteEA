<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlocoSugestao.aspx.cs"
    Inherits="SiteEA.Site.Formulario.BlocoSugestao" %>
...
<body>
    ...
    <div class="divPrincipal">
        <div class="divCabecalho">
            ...
            <div class="divNome">
                Nome:
                <asp:Label runat="server" ID="lblNome" class="tipoFundo" Text="_______________________________________________________" />
            </div>
        </div>
